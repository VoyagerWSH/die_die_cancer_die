CUDA_VISIBLE_DEVICES=0,1,2,3 python scripts/main.py --monitor_key val_6year_auc --model_name risk_model --dataset_name nlst --project_name part3.1_risk_model
# CUDA_VISIBLE_DEVICES=0,1 python scripts/main.py --model_name risk_model --dataset_name nlst --project_name part3.1_risk_model
# CUDA_VISIBLE_DEVICES=0,2 python scripts/main.py --model_name attn_guided_resnet --dataset_name nlst --project_name part2.1_attn_guided_resnet
